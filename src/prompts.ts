    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            "For a section and all its subsections, use get_node_content(doc_id, [node_id], include_descendants=true) — this is most efficient.",
    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            "- get_node_content(doc_id, [node_id], include_descendants=true) — that section + all its subsections",
            "",
            "## Step 3: If zero hits",
